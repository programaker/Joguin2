...
case class Save(gameProgress: GameProgress) extends GameProgressRepositoryOp[Unit]
...
class GameProgressRepository[F[_]](implicit I: InjectK[GameProgressRepositoryOp,F]) {
